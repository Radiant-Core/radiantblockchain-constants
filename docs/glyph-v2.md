...
This document provides a complete reference for Glyph v2 Token Standard constants exported by `@radiant-core/constants`.
...
```typescript
// Import everything
import * as constants from '@radiant-core/constants';
...
import * as glyph from '@radiant-core/constants/glyph';
```

## Magic Bytes

```typescript
import { GLYPH_MAGIC } from '@radiant-core/constants';
...
```typescript
import { GlyphVersion } from '@radiant-core/constants';
...
```typescript
import { GlyphProtocol } from '@radiant-core/constants';
...
```typescript
import { validateProtocols, getProtocolName } from '@radiant-core/constants';
...
```typescript
import { PROTOCOL_REQUIREMENTS, PROTOCOL_EXCLUSIONS, PROTOCOLS_REQUIRE_BASE } from '@radiant-core/constants';
...
```typescript
import { DmintAlgorithm } from '@radiant-core/constants';
...
```typescript
import { DaaMode } from '@radiant-core/constants';
...
```typescript
import { GlyphLimits } from '@radiant-core/constants';
...
```typescript
import { EnvelopeFlags } from '@radiant-core/constants';
...
```typescript
import { ContainerType } from '@radiant-core/constants';
...
```typescript
import { AuthorityType, AuthorityPermission } from '@radiant-core/constants';
...
```typescript
import { UpdateOperation } from '@radiant-core/constants';
...
```typescript
import { StorageType } from '@radiant-core/constants';
...
```typescript
import { EncryptionAlgorithm, EncryptionMinimums } from '@radiant-core/constants';
...
```typescript
import { RecommendedMinDifficulty, DmintAlgorithm } from '@radiant-core/constants';
...
```typescript
import { PROTOCOL_REPS, GlyphProtocol } from '@radiant-core/constants';
...
```typescript
import { GlyphDefaults } from '@radiant-core/constants';
